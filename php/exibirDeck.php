...
<?php
				...
				$sql = "SELECT data, p.nome, quantidade, responsavel FROM produto as p, registro WHERE p.idProduto=fk_idProduto AND fk_ID= 11";
				...
				if($total == 0){
					...
					echo "<b>Não Há retiradas do estoque para o DECK. </b>";
